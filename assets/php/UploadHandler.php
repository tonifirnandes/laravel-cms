...
class UploadHandler {
    ...
    //private $uploadFolder = '/home3/changegl/public_html/files/images/';
    private $uploadFolder = 'C:/xampp/htdocs/qmall_cms/privasi/assets/upload';
...
//|3gpp|3gp|mp4|mpeg|webm
    protected function fix_file_extension($file_path, $name, $size, $type, $error, $index, $content_range) {
        ...
        return str_replace('3gpp','3gp',str_replace('video/','',$name));
    }
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error, $index = null, $content_range = null) {
        $file = new \stdClass();
        $date = time().mt_rand(1,10000);
        $file->name = $this->get_file_name($uploaded_file, $date, $size, $type, $error, $index, $content_range);
